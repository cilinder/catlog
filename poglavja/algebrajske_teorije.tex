...
\begin{dokaz}
  ...
  Dodatno iz diagrama \ref{diag:univerzalna-operacija} sledi, da za vsako osnovno operacijo $fa$,
  do izomorfizma natančno velja
  \[ [f]^A = ([f]^U)^{*} = \Hom([f]^U,A) = A^{\#}([f]^U).\]
  Torej, kot algebri $A^{\#} \cong A$. Vsak homomorfizem $h : F(U) \to G(U)$ $\T$-algeber
