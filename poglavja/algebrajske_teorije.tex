...
Vse algebrajske teorije imajo mnogo skupnih mnogo splošnih lastnosti.
...
Kategorija mora zadoščati naslednjima aksiomoma:
  ...
  \item Vsakemu objektu priredimo identitetni m
    orfizem
...
Pomembno (za naš pristop) da so operacije definirane za celotno strukturo,
...
\begin{definicija}
  ...
  teorije. Enačbe iz $A_{\mathbb{T}}$ imenujemo \emph{aksiomi} teorije $\mathbb{T}$. Formalno so
...
\begin{primer}
  ...
  Imamo dve nič-mestni operaciji (konstanti) $0$ in $1$, eno eniško operacijo
