...
\begin{lema}\label{lema:morfizmi-v-sintakticni-kategoriji}
  ...
  \item
    ...
    Če je \eqref{diag:jedrni-par-v-sintaktični-kategoriji} kozožek, je $\{ \varphi\}$
    ...
    \eqref{diag:jedrni-par-v-sintaktični-kategoriji}. V ta namen recimo, da imamo morfizem
